...
![CI](https://github.com/AstraM86/credit-card-validator/actions/workflows/deploy.yml/badge.svg)

[GitHub Pages](https://AstraM86.github.io/credit-card-validator/)
...
Удостоверьтесь, что всё работает при прогоне тестов в GitHub Actions.

<details>
<summary>Подсказка</summary>

Для поиска изображений можете воспользоваться сервисом [icons8.ru](https://icons8.ru/icons)**
</details>
